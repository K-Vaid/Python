...
Code Challenge
  ...
  Filename: 
    bmi_cal_hindi.py
  Problem Statement:
    Convert the BMI program to use hindi titles while taking input and print weight, height and BMI in Hindi script using formatted strings concept   
  Hint: 
     Create a copy of the old bmi_cal.py program and do modification
"""

print (u"\u0915\u093F\u0932\u094B\u0917\u094D\u0930\u093E\u092E \u092E\u0947\u0902 \u0905\u092A\u0928\u093E \u0935\u091C\u0928 \u0926\u0930\u094D\u091C \u0915\u0930\u0947\u0902"+" : ")

# Take weight from user
weight = float(input())

print (u"\u092E\u0940\u091F\u0930 \u092E\u0947\u0902 \u0905\u092A\u0928\u0940 \u090A\u0902\u091A\u093E\u0908 \u0926\u0930\u094D\u091C \u0915\u0930\u0947\u0902"+" : ")
